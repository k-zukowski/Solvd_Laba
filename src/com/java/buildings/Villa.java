...
public class Villa extends Building implements IBuildingTypeFunctionality {
    ...
    public Villa(float height, float width, float length, int storyCount, boolean isBasement, boolean isUndergroundCarpark, ArrayList<Architect> architects, ArrayList<Builder> builders, int poolCount, boolean isCarGarage) {
